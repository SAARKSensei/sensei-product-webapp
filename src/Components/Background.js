...
const pages = () => {
  return (
    <div className="h-screen w-screen absolute opacity-15	z-0 hidden sm:block">
      ...
      <Image src={Heart} alt="heart" className="absolute top-1/4" />
      <Image
        src={Thumb}
        alt="thumb"
        className="absolute top-1/4 left-1/4 ml-40"
      />
      <Image src={Bulb} alt="buld" className="absolute left-3/4 ml-60 top-20" />
      <Image
        src={Puzzle}
        alt="puzzle"
