...
const UserDashboard = () => {
  ...
  return (
    <div className="w-full h-screen flex flex-col items-center lg:px-20  from-gray-200 to-white ">
      <Background1 />
      <Navbar3 />
      <div className="w-full mt-[200px] flex items-center flex-col gap-5 px-5">
        <div className="w-[353px] md:w-full inline-flex flex-col items-start gap-1 m-auto ">
          <p className="text-gray-800 font-NunitoSans text-sm sm:text-lg font-semibold sm:font-bold tracking-tighter uppercase">
            Hello!
          </p>
          <Link className="no-underline" href={address}>
            <p className="text-black font-NunitoSans text-2xl sm:text-4xl font-semibold tracking-tighter">
              Avatar name
            </p>
          </Link>
          <p className="text-gray-800 font-NunitoSans text-sm sm:text-lg font-normal tracking-tighter">
