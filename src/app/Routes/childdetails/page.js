    ...
    <div className="h-screen w-screen">
      ...
      <div className='flex flex-col justify-center items-center'>
        ...
        <div className="flex flex-col sm:flex-row justify-center items-center sm:gap-12 gap-2 mt-5">
          ...
          <div className="flex sm:flex-col justify-between sm:justify-center items-center px-2 sm:px-6 sm:py-20 w-[353px] h-12 sm:w-[283px] sm:h-[344px] border-2 sm:border-4	border-[#F58720] rounded-lg sm:flex sm:gap-10 cursor-pointer mt-8 sm:mt-0 z-50">
